...
/** PRD §14. The two workflows the video shows; also what `scripts/demo.sh` runs. */
export const DEMO_TASKS: DemoTask[] = [
  ...
  },
  {
    ...
    expected_tools: ['hr__lookup_person_profile', 'hr__check_pto_balance', 'policy__search_policy_documents', 'hr__draft_hr_email'],
  },
];
